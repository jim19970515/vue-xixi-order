...
<template>
  <div class="flex flex-col h-full px-4 gap-4">
      ...
      <div class="overflow-y-auto max-h-full z-20">
        <div class="flex flex-col gap-2">
          <div class="flex justify-between items-center px-4 py-2 bg-white rounded-xl shadow-md" v-for="item in filterProduct" :key="item.id">
